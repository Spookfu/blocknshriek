...
execute if score @s heartbeat-timer matches 0 run execute if items entity @s hotbar.8 minecraft:lime_concrete run scoreboard players set @s heartbeat-timer 100
...
execute if score @s heartbeat-timer matches 0 run execute if items entity @s hotbar.8 minecraft:red_concrete run scoreboard players set @s heartbeat-timer 15
