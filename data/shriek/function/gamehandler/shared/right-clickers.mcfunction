...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:white_dye",count:1,components:{"minecraft:custom_data":{crypt:1b}}}}] run function shriek:gamehandler/hub/maps/choose-crypt
