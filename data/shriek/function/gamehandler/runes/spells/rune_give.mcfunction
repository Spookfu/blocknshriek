...
execute if score @s slot3 matches 1.. run clear @s[nbt=!{Inventory:[{count:1,Slot:2b, components:{"minecraft:custom_data":{rune:1}}}]},tag=Players] #minecraft:trim_templates
execute if score @s slot2 matches 1.. run clear @s[nbt=!{Inventory:[{count:1,Slot:1b, components:{"minecraft:custom_data":{rune:1}}}]},tag=Players] #minecraft:trim_templates
execute if score @s slot1 matches 1.. run clear @s[nbt=!{Inventory:[{count:1,Slot:0b, components:{"minecraft:custom_data":{rune:1}}}]},tag=Players] #minecraft:trim_templates
