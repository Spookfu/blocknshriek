...
execute if score @s hiding-timer matches ..0 run scoreboard players add @s hiding-anim 1
...
execute if score @s[scores={hiding=1500..}] hiding-timer matches ..0 run scoreboard players set @s hiding-timer 20
