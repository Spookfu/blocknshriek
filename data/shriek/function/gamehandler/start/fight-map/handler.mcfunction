...
item replace entity @a hotbar.2 with minecraft:arrow 64
item replace entity @a hotbar.3 with minecraft:cooked_beef 16
item replace entity @a hotbar.4 with minecraft:crossbow
item replace entity @a hotbar.5 with golden_apple 3
