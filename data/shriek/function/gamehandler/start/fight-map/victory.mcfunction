...
execute if entity @a[scores={mapKills=1},tag=chosen_dungeon] run title @a subtitle {"text":"Creaking Crypts Wins!","color":"red","bold":true}
execute if entity @a[scores={mapKills=1},tag=chosen_stalking] run title @a subtitle {"text":"Stalking Forest Wins!","color":"gray","bold":true}
execute if entity @a[scores={mapKills=1},tag=chosen_sculk] run title @a subtitle {"text":"Sculked Institute Wins!","color":"aqua","bold":true}
