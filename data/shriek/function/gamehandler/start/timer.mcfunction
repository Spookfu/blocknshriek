...
execute unless score gameTimer gameHandler matches ..0 run schedule function shriek:gamehandler/start/timer 1t
execute if score gameTimer gameHandler matches ..0 run function shriek:gamehandler/start/end_anim
...
execute if score timeSegments gameHandler > minutes gameHandler run function shriek:gamehandler/start/segmenters
