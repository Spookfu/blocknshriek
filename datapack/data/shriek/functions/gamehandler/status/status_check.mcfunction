...
execute if entity @s[scores={sprint-time=150..},tag=!sneaking] run execute unless score @s shrieker-timer matches 0 run scoreboard players remove @s shrieker-timer 2
